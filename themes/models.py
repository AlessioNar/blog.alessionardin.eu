...
from blogalessionardineu.settings.base import STATIC_URL
...
class Theme(BaseSetting):
    ...
    def print_scss(self):
        ...
        with open(os.path.join(NAME, "static/scss/themes/theme.scss"), "w") as f:
            ...
            f.write("@import 'blogalessionardineu/static/scss/bootswatch/_variables';\n")
            f.write("@import 'blogalessionardineu/static/scss/bootstrap/bootstrap';\n")
            f.write("@import 'blogalessionardineu/static/scss/bootswatch/bootswatch';\n")
